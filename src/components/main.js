                ...
                <div className="col">
                    ...
                    <div className="d-flex justify-content-center">
                        ...
                        height="50" className="rounded-circle me-2" />
                                 <div className="dl-flex flex-column">
                                <h5 className="card-title mb-2">XXX person is Recommending</h5>
                               
                              
                                <h6 className="card-subtitle mb-2 ">What thing</h6>
                                </div>
                                </div>
                                <p className="card-text">Recommendention text</p>
                ...
                <div className="col d-none d-sm-block d-sm-none d-md-block ">
                    ...
                    <div className="d-flex  justify-content-right col col-row-3">
                        ...
                        height="50" className="rounded-circle me-2" />
                                ...
                                <label className="card-category  position-absolute start-0 bottom-3 mb-3"><i class="bi bi-controller"></i> game</label>
