        ...
        <div className="d-flex flex-column flex-shrink-0 p-3 bg-body-tertiary bg-gradient" style={{ width: "280px" }}>
            ...
            <ul className="nav nav-pills flex-column mb-auto">
                <li className="nav-item">
                    <a href="home" className="nav-link link-body-emphasis" aria-current="page">
                ...
                <li className="nav-item">
                    <a href="/recommend" className="nav-link link-body-emphasis">
                ...
                <li className="nav-item">
                    <a href="/search" className="nav-link link-body-emphasis">
