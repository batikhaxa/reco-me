    ...
    return (
        <div className="d-flex flex-column flex-shrink-0 p-3 bg-body-tertiary bg-gradient" style={{ width: "280px" }}>
            ...
            <ul className="nav nav-pills flex-column mb-auto fs-6 fw-semibold">
                ...
                <li className="nav-item">
                    <NavLink to="/recommend" className="nav-link link-body-emphasis" activeClassName="active">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-hand-thumbs-up me-2" viewBox="0 0 16 16">
                ...
                <li className="nav-item">
                    <NavLink to="/search" className="nav-link link-body-emphasis" activeClassName="active">
